...
export default function MethodPage() {
  ...
  return (
    <Layout.Content sx={{ rowGap: 12, paddingX: { xs: 4, lg: 8 } }}>
      {/* Header */}
        ...
        <ResponsiveStack sx={{ flexDirection: "row", columnGap: 4 }}>
          <ResponsiveStack rowGap={7.5} sx={{ flex: 1 }}>
            ...
            >
              ...
              />
              <CustomTimelineItem
                content={<Typography>Livraison en&nbsp;production</Typography>}
              />
              <CustomTimelineItem
                content={
                  <Typography>
        ...
        <ResponsiveStack sx={{ flexDirection: "row", columnGap: 4 }}>
          ...
          <ResponsiveStack rowGap={3} sx={{ paddingY: "12px" }}>
            <Typography>
              ...
              pertinent, des cycles courts de type sprint.
            </Typography>
            <Typography>
            ...
            <Typography>
              ...
              pour la planification, la rédaction des tâches, leur estimation et
              leur priorisation. Chaque tâche est décrite de manière structurée,
              avec un contexte clair, une intention fonctionnelle, des critères
            ...
            <Typography>
              ...
              progressive avec suivi des livraisons. Cette approche permet de
              conserver une forte agilité tout en gardant une visibilité claire
          ...
          <SectionCard title="Produit existant">
            ...
            <Typography>
              ...
              l’accumulation de dette technique ou l’introduction de
              régressions.
            </Typography>
            <Typography>
          ...
          >
            <SectionCard title="Design System" sx={{ flex: 1 }}>
              ...
              <Typography>
                ...
                une couleur secondaire, une couleur d’accent ainsi qu’une
                palette de couleurs neutres destinée aux éléments de fond, de
                surface et de séparation. À cela s’ajoute un système de feedback
                standardisé composé de quatre états fonctionnels : erreur,
                avertissement, succès et information.
              </Typography>
              <Typography>
              ...
              <Typography>
                ...
                chaque projet, ce qui permet de bénéficier d’un socle robuste
                tout en conservant une flexibilité de personnalisation forte au
                niveau de l’identité visuelle et des besoins fonctionnels.
              </Typography>
            </SectionCard>
          </ResponsiveStack>
          {/* Wireframe & Maquettes */}
          <ResponsiveStack sx={{ flex: 1, rowGap: 3 }}>
            ...
            <SectionCard title="Maquettes">
              ...
              <Typography>
                ...
                les comportements attendus, les différents états des composants
                et les règles d’interaction, afin de limiter les interprétations
                et d’assurer une intégration fluide entre design et code.
              </Typography>
            </SectionCard>
          </ResponsiveStack>
        </ResponsiveStack>
        ...
        <ResponsiveStack sx={{ flexDirection: "row", columnGap: 4 }}>
          ...
          <SectionCard sx={{ flex: 1 }} title="Interface d’administration">
            <Typography>
              ...
              médias centralisée, ainsi qu’un système de rôles et de permissions
              permettant de contrôler les accès des différents utilisateurs.
            </Typography>
            <Typography>
              ...
              techniques. L’objectif est de limiter les actions complexes,
              réduire les risques d’erreur et permettre une prise en main rapide
              de l’outil.
            </Typography>
          </SectionCard>
          {/* Interface publique */}
          <SectionCard sx={{ flex: 1 }} title="Interface publique">
            ...
            <Typography>
              ...
              utilisateurs sont utilisés pour rendre l’interface compréhensible
              et réactive. Le temps de chargement et la stabilité de l’interface
              sont optimisés afin de garantir une expérience fluide, y compris
              sur des connexions ou des appareils moins performants.
            </Typography>
          </SectionCard>
        </ResponsiveStack>
      </ResponsiveStack>
        ...
        <ResponsiveStack sx={{ flexDirection: "row", columnGap: 4 }}>
          ...
          <SectionCard sx={{ flex: 1 }} title="Frontend">
            ...
            <Typography>
              ...
              l’application fonctionne comme une interface entièrement autonome,
              où les contenus sont soit intégrés directement dans le code, soit
              consommés via des sources externes simples (fichiers ou services).
            </Typography>
            <Typography>
            ...
            <Typography>
              ...
              être intégrés via WebSocket, notamment pour des besoins de mise à
              jour instantanée (chat, notifications...). Le frontend peut
          ...
          <SectionCard sx={{ flex: 1 }} title="Backend">
            ...
            <Typography>
              ...
              logique métier, sécurise les échanges et garantit la cohérence des
              données.
            </Typography>
          </SectionCard>
          {/* Wordpress */}
        ...
        <ResponsiveStack sx={{ flexDirection: "row", columnGap: 4 }}>
          ...
          <SectionCard sx={{ flex: 1 }} title="Sécurité">
            ...
            <Typography>
              ...
              inclut notamment la sécurisation des accès API, la validation des
              données côté serveur, la gestion des permissions utilisateurs et
              la protection contre les injections et requêtes non autorisées.
            </Typography>
            <Typography>
          ...
          <SectionCard sx={{ flex: 1 }} title="Tests">
            ...
            <Typography>
              ...
              structurés, tandis que les projets plus complexes peuvent intégrer
              des tests automatisés pour sécuriser les règles métier et les
          ...
          <SectionCard sx={{ flex: 1 }} title="Documentation">
            ...
            <Typography>
              ...
              lisibilité, la transmission et la maintenabilité du système dans
              le temps.
            </Typography>
            <Typography>
              Elle inclut au minimum les informations essentielles au lancement
              de l’environnement, à la structure du projet et aux principaux
              workflows.
            </Typography>
          </SectionCard>
        </ResponsiveStack>
      ...
      <ResponsiveStack sx={{ flexDirection: "row", columnGap: 8 }}>
        ...
        <SectionCard sx={{ flex: 1 }}>
          ...
          <Typography>
            ...
            personne qui les utilise. La qualité d’un produit dépend avant tout
            de la capacité à structurer une architecture cohérente, comprendre
            les besoins métier implicites, appliquer les standards de
            développement et concevoir une expérience utilisateur claire et
            maintenable.
          </Typography>
          <Typography>
        ...
        <ResponsiveStack rowGap={3} sx={{ flex: 1, paddingY: "36px" }}>
          ...
          <Typography>
            ...
            entre local, staging et production. L’environnement local est
            conteneurisé via Docker Compose afin de garantir une reproduction
            fidèle des conditions d’exécution.
          </Typography>
          <Typography>
          ...
          <Typography>
            ...
            l’application et le déploiement sur l’environnement cible. Un
            contrôle manuel peut être conservé avant la mise en production
            lorsque le niveau de risque le nécessite.
          </Typography>
          <Typography>
      ...
      <ResponsiveStack rowGap={3}>
        ...
        />
        <Typography>
          Mon environnement de travail est pensé comme un espace de production à
          part entière.
        </Typography>
        <Typography>
          ...
          conteneurisés, TablePlus pour l’administration des bases de données et
          Postman pour les tests et la validation des APIs.
        </Typography>
